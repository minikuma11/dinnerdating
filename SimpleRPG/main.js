...
$(document).keydown(function(event) {
    ...
    //targetImgMainX, ttargetImgMainY：主角即將要移動過去的目標位置
    // targetBlock：主角即將移動過去的那一格編號
    //cutImagePositionX依據主角朝向什麼方向而決定圖片
    event.preventDefault();
    //避免點及鍵盤出現瀏覽器其他行為，如捲動、放大、換頁...
    ...
    switch (event.which){
        case 37://往左走
            ...
            break;
        case 38://往上走
            ttargetImgMainX = currentImgMainX;
            ...
            targetImgMainY<=400 && targetImgMainY>=0)//沒有超出邊界
{
    ...
    {
       //目前位置異常、遇到障礙物、遇到敵人都不能走,在原地(但稍後會依移動方向轉頭)
    }
    else
    {
        $("#talkBox").text("");
